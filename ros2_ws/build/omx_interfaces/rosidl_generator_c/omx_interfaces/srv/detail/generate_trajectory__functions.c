...
omx_interfaces__srv__GenerateTrajectory_Request__create(void)
{
  ...
  omx_interfaces__srv__GenerateTrajectory_Request * msg = (omx_interfaces__srv__GenerateTrajectory_Request *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(omx_interfaces__srv__GenerateTrajectory_Request));
  bool success = omx_interfaces__srv__GenerateTrajectory_Request__init(msg);
  if (!success) {
...
omx_interfaces__srv__GenerateTrajectory_Request__Sequence__init(omx_interfaces__srv__GenerateTrajectory_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Request * data = NULL;

  if (size) {
    data = (omx_interfaces__srv__GenerateTrajectory_Request *)allocator.zero_allocate(size, sizeof(omx_interfaces__srv__GenerateTrajectory_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = omx_interfaces__srv__GenerateTrajectory_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        omx_interfaces__srv__GenerateTrajectory_Request__fini(&data[i - 1]);
      }
...
omx_interfaces__srv__GenerateTrajectory_Request__Sequence__fini(omx_interfaces__srv__GenerateTrajectory_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      omx_interfaces__srv__GenerateTrajectory_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Request__Sequence * array = (omx_interfaces__srv__GenerateTrajectory_Request__Sequence *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = omx_interfaces__srv__GenerateTrajectory_Request__Sequence__init(array, size);
  if (!success) {
...
omx_interfaces__srv__GenerateTrajectory_Request__Sequence__destroy(omx_interfaces__srv__GenerateTrajectory_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    omx_interfaces__srv__GenerateTrajectory_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
omx_interfaces__srv__GenerateTrajectory_Request__Sequence__are_equal(const omx_interfaces__srv__GenerateTrajectory_Request__Sequence * lhs, const omx_interfaces__srv__GenerateTrajectory_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  omx_interfaces__srv__GenerateTrajectory_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(omx_interfaces__srv__GenerateTrajectory_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    omx_interfaces__srv__GenerateTrajectory_Request * data =
      (omx_interfaces__srv__GenerateTrajectory_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!omx_interfaces__srv__GenerateTrajectory_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          omx_interfaces__srv__GenerateTrajectory_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Request__copy(
...
omx_interfaces__srv__GenerateTrajectory_Response__init(omx_interfaces__srv__GenerateTrajectory_Response * msg)
{
  ...
  if (!trajectory_msgs__msg__JointTrajectory__init(&msg->trajectory)) {
    omx_interfaces__srv__GenerateTrajectory_Response__fini(msg);
    return false;
  }
  // success
  // message
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Response * msg = (omx_interfaces__srv__GenerateTrajectory_Response *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(omx_interfaces__srv__GenerateTrajectory_Response));
  bool success = omx_interfaces__srv__GenerateTrajectory_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
omx_interfaces__srv__GenerateTrajectory_Response__Sequence__init(omx_interfaces__srv__GenerateTrajectory_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Response * data = NULL;

  if (size) {
    data = (omx_interfaces__srv__GenerateTrajectory_Response *)allocator.zero_allocate(size, sizeof(omx_interfaces__srv__GenerateTrajectory_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = omx_interfaces__srv__GenerateTrajectory_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        omx_interfaces__srv__GenerateTrajectory_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
omx_interfaces__srv__GenerateTrajectory_Response__Sequence__fini(omx_interfaces__srv__GenerateTrajectory_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      omx_interfaces__srv__GenerateTrajectory_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Response__Sequence * array = (omx_interfaces__srv__GenerateTrajectory_Response__Sequence *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = omx_interfaces__srv__GenerateTrajectory_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
omx_interfaces__srv__GenerateTrajectory_Response__Sequence__destroy(omx_interfaces__srv__GenerateTrajectory_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    omx_interfaces__srv__GenerateTrajectory_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
omx_interfaces__srv__GenerateTrajectory_Response__Sequence__are_equal(const omx_interfaces__srv__GenerateTrajectory_Response__Sequence * lhs, const omx_interfaces__srv__GenerateTrajectory_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  omx_interfaces__srv__GenerateTrajectory_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(omx_interfaces__srv__GenerateTrajectory_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    omx_interfaces__srv__GenerateTrajectory_Response * data =
      (omx_interfaces__srv__GenerateTrajectory_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!omx_interfaces__srv__GenerateTrajectory_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          omx_interfaces__srv__GenerateTrajectory_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
omx_interfaces__srv__GenerateTrajectory_Event__init(omx_interfaces__srv__GenerateTrajectory_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    omx_interfaces__srv__GenerateTrajectory_Event__fini(msg);
    return false;
  }
  // request
  if (!omx_interfaces__srv__GenerateTrajectory_Request__Sequence__init(&msg->request, 0)) {
    omx_interfaces__srv__GenerateTrajectory_Event__fini(msg);
    return false;
  }
  // response
  if (!omx_interfaces__srv__GenerateTrajectory_Response__Sequence__init(&msg->response, 0)) {
    omx_interfaces__srv__GenerateTrajectory_Event__fini(msg);
    return false;
  }
  return true;
...
omx_interfaces__srv__GenerateTrajectory_Event__fini(omx_interfaces__srv__GenerateTrajectory_Event * msg)
{
  ...
  // request
  omx_interfaces__srv__GenerateTrajectory_Request__Sequence__fini(&msg->request);
  // response
  omx_interfaces__srv__GenerateTrajectory_Response__Sequence__fini(&msg->response);
}
...
omx_interfaces__srv__GenerateTrajectory_Event__are_equal(const omx_interfaces__srv__GenerateTrajectory_Event * lhs, const omx_interfaces__srv__GenerateTrajectory_Event * rhs)
{
  ...
  // request
  if (!omx_interfaces__srv__GenerateTrajectory_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!omx_interfaces__srv__GenerateTrajectory_Response__Sequence__are_equal(
  ...
  omx_interfaces__srv__GenerateTrajectory_Event * output)
{
  ...
  // request
  if (!omx_interfaces__srv__GenerateTrajectory_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!omx_interfaces__srv__GenerateTrajectory_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Event * msg = (omx_interfaces__srv__GenerateTrajectory_Event *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(omx_interfaces__srv__GenerateTrajectory_Event));
  bool success = omx_interfaces__srv__GenerateTrajectory_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
omx_interfaces__srv__GenerateTrajectory_Event__Sequence__init(omx_interfaces__srv__GenerateTrajectory_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Event * data = NULL;

  if (size) {
    data = (omx_interfaces__srv__GenerateTrajectory_Event *)allocator.zero_allocate(size, sizeof(omx_interfaces__srv__GenerateTrajectory_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = omx_interfaces__srv__GenerateTrajectory_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        omx_interfaces__srv__GenerateTrajectory_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
omx_interfaces__srv__GenerateTrajectory_Event__Sequence__fini(omx_interfaces__srv__GenerateTrajectory_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      omx_interfaces__srv__GenerateTrajectory_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  omx_interfaces__srv__GenerateTrajectory_Event__Sequence * array = (omx_interfaces__srv__GenerateTrajectory_Event__Sequence *)allocator.allocate(sizeof(omx_interfaces__srv__GenerateTrajectory_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = omx_interfaces__srv__GenerateTrajectory_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
omx_interfaces__srv__GenerateTrajectory_Event__Sequence__destroy(omx_interfaces__srv__GenerateTrajectory_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    omx_interfaces__srv__GenerateTrajectory_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
omx_interfaces__srv__GenerateTrajectory_Event__Sequence__are_equal(const omx_interfaces__srv__GenerateTrajectory_Event__Sequence * lhs, const omx_interfaces__srv__GenerateTrajectory_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  omx_interfaces__srv__GenerateTrajectory_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(omx_interfaces__srv__GenerateTrajectory_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    omx_interfaces__srv__GenerateTrajectory_Event * data =
      (omx_interfaces__srv__GenerateTrajectory_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!omx_interfaces__srv__GenerateTrajectory_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          omx_interfaces__srv__GenerateTrajectory_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!omx_interfaces__srv__GenerateTrajectory_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
