...
#include "omx_interfaces/srv/detail/generate_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const omx_interfaces::srv::GenerateTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<omx_interfaces::srv::GenerateTrajectory_Request *>(
    untyped_ros_message);
...
{
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omx_interfaces, srv, GenerateTrajectory_Request)() {
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_omx_interfaces
cdr_serialize(
  const omx_interfaces::srv::GenerateTrajectory_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: trajectory
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  omx_interfaces::srv::GenerateTrajectory_Response & ros_message)
{
  // Member: trajectory
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = omx_interfaces::srv::GenerateTrajectory_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const omx_interfaces::srv::GenerateTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<omx_interfaces::srv::GenerateTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omx_interfaces, srv, GenerateTrajectory_Response)() {
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Response__handle;
}
...
// functions for omx_interfaces::srv::GenerateTrajectory_Request already declared above

// functions for omx_interfaces::srv::GenerateTrajectory_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_omx_interfaces
cdr_serialize(
  const omx_interfaces::srv::GenerateTrajectory_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  omx_interfaces::srv::GenerateTrajectory_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        omx_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GenerateTrajectory_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        omx_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GenerateTrajectory_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = omx_interfaces::srv::GenerateTrajectory_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        omx_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GenerateTrajectory_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        omx_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GenerateTrajectory_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const omx_interfaces::srv::GenerateTrajectory_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<omx_interfaces::srv::GenerateTrajectory_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omx_interfaces, srv, GenerateTrajectory_Event)() {
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory_Event__handle;
}
...
static const rosidl_service_type_support_t _GenerateTrajectory__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<omx_interfaces::srv::GenerateTrajectory_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<omx_interfaces::srv::GenerateTrajectory_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<omx_interfaces::srv::GenerateTrajectory_Event>(),
...
{
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omx_interfaces, srv, GenerateTrajectory)() {
  return &omx_interfaces::srv::typesupport_fastrtps_cpp::_GenerateTrajectory__handle;
}
