...
class GenerateTrajectory_Event(metaclass=Metaclass_GenerateTrajectory_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<omx_interfaces/GenerateTrajectory_Request, 1>',
        'response': 'sequence<omx_interfaces/GenerateTrajectory_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['omx_interfaces', 'srv'], 'GenerateTrajectory_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['omx_interfaces', 'srv'], 'GenerateTrajectory_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from omx_interfaces.srv import GenerateTrajectory_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from omx_interfaces.srv import GenerateTrajectory_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GenerateTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'omx_interfaces.srv.GenerateTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from omx_interfaces.srv import _generate_trajectory
...
class GenerateTrajectory(metaclass=Metaclass_GenerateTrajectory):
    from omx_interfaces.srv._generate_trajectory import GenerateTrajectory_Request as Request
    from omx_interfaces.srv._generate_trajectory import GenerateTrajectory_Response as Response
    from omx_interfaces.srv._generate_trajectory import GenerateTrajectory_Event as Event
