...
bool omx_interfaces__srv__generate_trajectory__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // qi
    PyObject * field = PyObject_GetAttrString(_pymsg, "qi");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->qi.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'qi'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * omx_interfaces__srv__generate_trajectory__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // qi
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "qi");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->qi.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->qi.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->qi.size * sizeof(double));
      assert(data != NULL);
