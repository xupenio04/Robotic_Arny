...
// IWYU pragma: private, include "omx_interfaces/srv/execute_trajectory.h"


#ifndef OMX_INTERFACES__SRV__DETAIL__EXECUTE_TRAJECTORY__FUNCTIONS_H_
#define OMX_INTERFACES__SRV__DETAIL__EXECUTE_TRAJECTORY__FUNCTIONS_H_
 ...
 * )) before or use
 * omx_interfaces__srv__ExecuteTrajectory_Request__create()
 ...
 * calls
 * omx_interfaces__srv__ExecuteTrajectory_Request__init().
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Request__fini()
 ...
 * omx_interfaces__srv__ExecuteTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * omx_interfaces__srv__ExecuteTrajectory_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * omx_interfaces__srv__ExecuteTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It allocates the memory for the array and calls
 * omx_interfaces__srv__ExecuteTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * omx_interfaces__srv__ExecuteTrajectory_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * omx_interfaces__srv__ExecuteTrajectory_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It allocates the memory for the array and calls
 * omx_interfaces__srv__ExecuteTrajectory_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omx_interfaces
...
/**
 * It calls
 * omx_interfaces__srv__ExecuteTrajectory_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OMX_INTERFACES__SRV__DETAIL__EXECUTE_TRAJECTORY__FUNCTIONS_H_
